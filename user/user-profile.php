...
'<div  class="alert alert-success alert-dismissable" style="text-align: center" fade in>
 <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
  <strong></strong>Profile info Update Susscessfuly.
</div>';

 $URL="user-profile.php?u=".$update_id;
...
<div class="add-service text-center">
	...
	<h2>Update Info</h2>
		<form class="form-horizontal"  action="user-profile.php?update_id=<?php echo $id;  ?> " method="post" id="signup-form">
    ...
    <?php
		   ...
		   <div class="form-group">
		    <label class="control-label col-sm-4" for="pwd">Services Type:</label>
		    <div class="col-sm-6"> 
