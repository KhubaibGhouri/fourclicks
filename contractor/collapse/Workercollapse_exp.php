<div class="collapse" id="scollapseExample1">
...
//$result = "SELECT * FROM coder WHERE Documenttype='Worker Comp Insurance' WHERE BusinessName = '$BusinessName'";
...
$date = date("Y-m-d");
$result = "SELECT * FROM coder WHERE Documenttype='Worker Comp Insurance' and Enddate <  '$date' and user_id = '$user_id'";
