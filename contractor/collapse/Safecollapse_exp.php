<div class="collapse" id="sscollapseExample1003">
...
//$result = "SELECT * FROM coder WHERE Documenttype='Safe Work Method Statement' WHERE BusinessName='$BusinessName'";
$date = date("Y-m-d");
$result = "SELECT * FROM coder WHERE Documenttype='Safe Work Method Statement' and Enddate <  '$date' and user_id = '$user_id'";
