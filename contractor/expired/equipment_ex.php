...
$Equipmentname=$row['Equipmentname'];
    $result2 = "SELECT ID,BusinessName,Startdate,Enddate,File,SerialNumber,Equipmentname,doc_status FROM  `coder` where Enddate <  '$date' and SerialNumber!= '' and user_id = '$user_id'  and Equipmentname = '$Equipmentname'";
                ...
                $sql2 = $conn->query($result2);
                    ?>         
	                   <a class="btn btn-default btn-sm document" role="button" data-toggle="collapse" href="#collapseExample41-<?php echo $row['ID']; ?>" aria-expanded="false" aria-controls="collapseExample"><?php echo $row['Equipmentname']; ?> (<?=$sql2->num_rows; ?>)</a><br>
...
$date = date("Y-m-d");
   ...
   echo "<td>N/A</td>";
    ...
    echo "<td><a  href='edit3.php?edit3=$row2[ID]' target='_blank'><span class='glyphicon' >&#xe065;</span></a>
