...
<style>.modal-backdrop.in{opacity: -0.5 !important; position: relative;}</style>
 <script>
   $(function() {
...
<div class="modal-content">
  ...
  <div class="modal-body">
    <form action="https://fourclicksolutions.com/demo2.php" id="testing" enctype="multipart/form-data"  method="POST">
