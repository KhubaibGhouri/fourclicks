  ...
  <div class="modal-body">
    ...
    <div class="form-group">
        <label for="Startdate">Start Date</label>
         <input id="datepicker002" class="form-control" class="datepicker" type="text" name="start" required="" /> 
    </div>
    <div class="form-group">
        <label for="Enddate">Expiry Date (If any)</label>
        <input id="datepicker001" class="form-control"  class="datepicker" type="text" name="end" required="" />
    </div>
    <div class="form-group">
...
<script>
  $( function() {
    $( "#datepicker001" ).datepicker();
  } );
  </script>
<script>
  $( function() {
    $( "#datepicker002" ).datepicker();
  } );
  </script>
</html>