  ...
  <div class="modal-body">
    ...
    <div class="form-group">
        <label for="Startdate">Start Date</label>
         <input id="datepicker" class="form-control datepicker" type="date" name="start" required="" /> 
    </div>
    <div class="form-group">
        <label for="Enddate">Expiry Date (If any)</label>
        <input id="datepicker1" class="form-control datepicker" type="date" name="end" required="" />
    </div>
